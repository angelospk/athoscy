...
<p style="position:relative; top:90%;" class="my-1 text-2xl w-fit rounded-lg text-white bg-stone-500 bg-opacity-40">{data.en}</p>
</div></a>
<!-- <p>{data.url}</p> -->
{/each}
</div>
...
<section class="card ">
    ...
    Our exhibition products are loading
